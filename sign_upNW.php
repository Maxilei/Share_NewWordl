        ...
        <p class="card-text">
	       	<form method="GET" action="Connexion_inscriptionNW.php">
	        	<fieldset class="formInsc">
					...
					<input type="text" name="adresse" id="idAdresse" placeholder="Adresse : N° de Rue - Nom de rue" oninput="completionAdresse()" list="datalistAdress" required><br>
					<input type="text" name="codePostal" placeholder="code postale"><br>
					<input type="text" name="ville" placeholder="Ville de résidence"><br><br>
...
<script type="text/javascript">
	function completionAdresse(){
	url="https://api-adresse.data.gouv.fr/search/?q=";
	adresse=document.getElementById("idAdresse");
	var maRequeteAdresse = url+adresse;
		alert (maRequeteAdresse);
	}
