...
CREATE TABLE `rayon`(`rayonId` INTEGER,`rayonNom` VARCHAR(25),`rayonImage` VARCHAR(25),`rayonValid` BOOL,primary key(`rayonId`));
...
CREATE TABLE `produit`(`prodID` INTEGER,`prodNom` VARCHAR(25),`prodImage` VARCHAR(50),`prodValid` BOOL,`rayonId` INTEGER NOT NULL, foreign key (`rayonId`) references rayon(`rayonId`),primary key(`prodID`));
...
CREATE TABLE `variete`(`varId` INTEGER,`varNom` VARCHAR(25),`varImage` VARCHAR(50),`varDescription` VARCHAR(250),`varValid` BOOL,`prodID` INTEGER NOT NULL, foreign key (`prodID`) references produit(`prodID`),primary key(`varId`));
