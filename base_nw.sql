...
CREATE TABLE `produit`(`prodID` INTEGER,`prodNom` VARCHAR(25),`prodDescription` VARCHAR(100),`prodImage` VARCHAR(50),`rayonId` INTEGER NOT NULL,`umId` INTEGER NOT NULL, foreign key (`rayonId`) references rayon(`rayonId`), foreign key (`umId`) references uniteMesure(`umId`),primary key(`prodID`));
